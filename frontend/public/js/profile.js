...
async function loadUserProfile() {
  try {
    ...
    if (!token) {
      window.location.href = '/auth/receptionist-dashboard';
      return;
    }
    ...
    document.querySelector(".receptionist-id").textContent = "Please try refreshing the page";
  }
}
...
function displayUserProfile(user) {
  ...
  document.querySelector(".receptionist-id").textContent = `ID: ${user.receptionistId}`;
